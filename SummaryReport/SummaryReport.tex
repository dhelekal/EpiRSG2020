...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\frac{d\mathbf{v}}{dt} &=& \mathbf{V}(\mathbf{s}+\mathbf{b})-\mathbf{d}\mathbf{v} +\delta_{t_{end}}(t)[(\mathbf{L}-\mathbf{I})\mathbf{A}\mathbf{v}+\mathbf{V}\mathbf{L}\mathbf{A}\mathbf{s}]\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{align*}
